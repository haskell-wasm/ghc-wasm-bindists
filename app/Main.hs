            ...
            src =
              GitLabArtifact
                { gitlabDomain = "gitlab.haskell.org",
                  projectId = 1,
                  ref = "master",
                  jobName = "nightly-x86_64-linux-alpine3_23-wasm-cross_wasm32-wasi-release+host_fully_static+text_simdutf",
                  artifactPath = "ghc-x86_64-linux-alpine3_23-wasm-cross_wasm32-wasi-release+host_fully_static+text_simdutf.tar.xz",
            ...
            src =
              GitLabArtifact
                { gitlabDomain = "gitlab.haskell.org",
                  projectId = 1,
                  ref = "master",
                  jobName = "nightly-x86_64-linux-alpine3_23-wasm-int_native-cross_wasm32-wasi-release+host_fully_static+text_simdutf",
                  artifactPath = "ghc-x86_64-linux-alpine3_23-wasm-int_native-cross_wasm32-wasi-release+host_fully_static+text_simdutf.tar.xz",
                  pipelineFilter = [("scope", Just "finished"), ("source", Just "schedule")]
                }
          },
      (,)
            ...
            src =
              GitLabArtifact
                { gitlabDomain = "gitlab.haskell.org",
                  projectId = 1,
                  ref = "master",
                  jobName = "nightly-x86_64-linux-alpine3_23-wasm-unreg-cross_wasm32-wasi-release+host_fully_static+text_simdutf",
                  artifactPath = "ghc-x86_64-linux-alpine3_23-wasm-unreg-cross_wasm32-wasi-release+host_fully_static+text_simdutf.tar.xz",
                  pipelineFilter = [("scope", Just "finished"), ("source", Just "schedule")]
                }
          },
      (,)
            ...
            src =
              GitLabArtifact
                { gitlabDomain = "gitlab.haskell.org",
                  projectId = 224,
                  ref = "ghc-9.10",
                  jobName = "x86_64-linux-alpine3_23-wasm-cross_wasm32-wasi-release+host_fully_static+text_simdutf",
                  artifactPath = "ghc-x86_64-linux-alpine3_23-wasm-cross_wasm32-wasi-release+host_fully_static+text_simdutf.tar.xz",
                  pipelineFilter = []
                }
          },
            ...
            src =
              GitLabArtifact
                { gitlabDomain = "gitlab.haskell.org",
                  projectId = 224,
                  ref = "ghc-9.14",
                  jobName = "aarch64-linux-alpine3_23-cross_wasm32-wasi-release+host_fully_static+text_simdutf",
                  artifactPath = "ghc-aarch64-linux-alpine3_23-cross_wasm32-wasi-release+host_fully_static+text_simdutf.tar.xz",
                  pipelineFilter = []
                }
          },
      (,)
