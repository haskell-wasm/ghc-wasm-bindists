            ...
            src =
              GitLabArtifact
                { gitlabDomain = "gitlab.haskell.org",
                  ...
                  artifactPath = "dist/wasi-sdk-26.0-x86_64-linux.tar.gz",
                  pipelineFilter = []
                }
          },
      (,)
            ...
            src =
              GitLabArtifact
                { gitlabDomain = "gitlab.haskell.org",
                  ...
                  artifactPath = "dist/wasi-sdk-26.0-arm64-macos.tar.gz",
                  pipelineFilter = []
                }
          },
      (,)
            ...
            src =
              GitLabArtifact
                { gitlabDomain = "gitlab.haskell.org",
                  ...
                  artifactPath = "dist/wasi-sdk-26.0-aarch64-linux.tar.gz",
                  pipelineFilter = []
                }
          },
      (,)
